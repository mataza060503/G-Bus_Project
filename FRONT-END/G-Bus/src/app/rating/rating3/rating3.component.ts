...
@Component({
  ...
  templateUrl: './rating3.component.html',
  styleUrl: './rating3.component.scss'
})
export class Rating3Component implements OnInit{
...
ngOnInit(): void {
  ...
  this.portImageSelected9 ="./assets/images/rating3/Logout.png"
